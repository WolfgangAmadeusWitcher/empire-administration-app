...
export class AngularEditorToolbarComponent {
  ...
  set customClasses(classes: CustomClass[]) {
    if (classes) {
      ...
      this.customClassList.unshift({label: 'Dynamic Field', value: '-1'});
    }
  }
  ...
  setCustomClass(classId: string) {
    console.log(classId);
    console.log(this.customClassList)
    let Name:string=this._customClasses[classId].name;
    if(classId!=='-1')
    this.editorService. createDynamicField(classId,Name)
    // if (classId === '-1') {
